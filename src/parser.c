...
enum {
  ...
  sym_annotName = 45,
  sym_simpleId = 46,
  aux_sym_dbscheme_repeat1 = 47,
  aux_sym_table_repeat1 = 48,
  aux_sym_table_repeat2 = 49,
  aux_sym_argsAnnotation_repeat1 = 50,
  aux_sym_unionDecl_repeat1 = 51,
  aux_sym_caseDecl_repeat1 = 52,
};
